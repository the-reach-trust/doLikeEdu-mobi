# Contributing to DoLikeEdu

We'd love for you to contribute to our source code and to make it even better than it already is.
...
* **PHP Version, Operating System and HTTP server** - is this a problem with a specific setup?
...
In GitHub, send a pull request to `doLikeEdu-mobi:master`.
...
[github]: https://github.com/the-reach-trust/doLikeEdu-mobi
